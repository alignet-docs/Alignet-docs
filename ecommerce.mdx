...
---
<h3 id="flujo-de-procesamiento-adquirente" className="ecommerce-flow-heading">Flujo de procesamiento adquirente</h3>

<Frame caption="Los pagos originados en Ecommerce, POS y aplicaciones móviles se procesan mediante la API de Alignet.">
  <img
    className="processing-hero ecommerce-flow-light"
    src="/images/procesamiento-adquirente-flujo.png"
    alt="Flujo de procesamiento adquirente desde Ecommerce, POS y aplicaciones móviles hacia Alignet y los bancos"
  />
  <img
    className="processing-hero ecommerce-flow-dark"
    src="/images/ecommerce-processing-dark.png"
    alt="Flujo de procesamiento adquirente en modo oscuro"
  />
</Frame>
...
<Warning>
  Los identificadores de adquirencia y los parámetros asignados por las marcas no deben enviarse dentro de la trama de autorización.

  Estos datos se configuran previamente durante el proceso de onboarding y registro de la entidad adquirente, en el cual se registran la llave de integración y los identificadores correspondientes, como `BID`, `PCR`, `ICA`, `BIN` y otros parámetros requeridos por cada marca.

  La plataforma utilizará esta configuración para identificar a la entidad y enrutar correctamente las transacciones.
</Warning>
...
<Card title="Response de autorización" icon="reply" href="/response">
