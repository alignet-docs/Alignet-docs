...
| **No cambian los estados**    | Bloqueo de notificaciones externas.             | Confirma con tu proveedor de hosting que se permitan peticiones `POST` desde las IPs de Alignet One.                               |
...
Para obtener detalles específicos de un error, el módulo de Alignet One cuenta con un sistema de registro interno.
...
<CardGroup cols={2}>
  <Card title="Enviar correo" icon="envelope" href="mailto:postventa.autenticacion@alignet.com">
    [postventa.autenticacion@alignet.com](mailto:postventa.autenticacion@alignet.com)
  </Card>

  <Card title="Volver al Inicio" icon="house" href="/pagos-virtuales/prestashop/introduccion">
