...
---
El plugin de Alignet One ofrece una integración nativa que se adapta al diseño de tu tienda, garantizando un flujo de pago fluido y seguro.
...
* **Flujo:**
  ...
  3. Al dar clic en "Pagar", se abre el **Formulario Seguro de Alignet One**.
...
<CardGroup cols={2}>
  <Card title="Gestión de pedidos" icon="clipboard-list" href="/pagos-virtuales/wordpress-woocommerce/gestion-de-pedidos-y-transacciones">
