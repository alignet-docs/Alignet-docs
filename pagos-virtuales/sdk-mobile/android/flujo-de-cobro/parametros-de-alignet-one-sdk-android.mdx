---
title: "Parámetros de Entrada y Salida de Alignet One SDK Android"
sidebarTitle: "Parámetros y respuestas"
description: "Referencia técnica de Android: parámetros y respuestas."
---
...
# Cobros: Parámetros de Entrada y Salida de Alignet One SDK Android

A continuación, se detallan los parámetros de entrada y salida de Alignet One SDK.
...
| **Parámetro**     | **Tipo**                                                                                                                                                    | **Long.** | **Descripción**                                                                                            | **Obligatorio** |
| :---------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- | :--------------------------------------------------------------------------------------------------------- | :-------------- |
| transactionId     | String                                                                                                                                                      | 25        | Identificar único de la transacción generado por Alignet One                                                    | SI              |
