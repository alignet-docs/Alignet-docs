---
title: "Inicializar Alignet One SDK Android"
...
La función de cobro permite invocar Alignet One SDK desde tu app Android para mostrar el formulario de pago y recibir el resultado de la operación.

<Info>
  Antes de inicializar el SDK, completa [Instalación SDK Android](/pagos-virtuales/sdk-mobile/android/instalacion) y genera un `Access Token` desde tu backend usando [Autenticación](https://docs.pay-me.com/api-de-pagos/autenticacion).
</Info>
...
<Card title="Parámetros de entrada y salida" icon="arrow-right" href="/pagos-virtuales/sdk-mobile/android/flujo-de-cobro/parametros-de-alignet-one-sdk-android">
