...
A continuación, se detallan los parámetros de entrada y salida de Alignet One SDK para el flujo de afiliaciones:
...
| **Parámetro**    | **Tipo**                                                                                                                                           | **Long.** | **Descripción**                                                                                                                                                                                                  | **Obligatorio** |
| :--------------- | :------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------- |
| affiliationId    | String                                                                                                                                             | 36        | Identificar único de la transacción generado por Alignet One                                                                                                                                                          | SI              |
