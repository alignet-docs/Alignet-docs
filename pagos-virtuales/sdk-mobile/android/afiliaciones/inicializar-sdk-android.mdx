...
description: "Inicializa Alignet One SDK Android para registrar o actualizar afiliaciones desde tu app móvil."
sidebarTitle: "Implementación"
---

<div className="ao-guide-rail ao-sdk-rail sdk-android not-prose"><a href="/pagos-virtuales/sdk-mobile/android/introduccion">← Android</a><span>ANDROID / IMPLEMENTA</span></div>
...
El flujo de afiliaciones permite registrar o actualizar información asociada a un beneficiario desde Alignet One SDK Android.

<Info>
  Antes de inicializar este flujo, completa [Instalación SDK Android](/pagos-virtuales/sdk-mobile/android/instalacion), revisa [Parámetros de afiliación](/pagos-virtuales/sdk-mobile/android/afiliaciones/parametros-de-sdk-android) y genera un `Access Token` desde backend usando [Autenticación](https://docs.pay-me.com/api-de-pagos/autenticacion).
</Info>
...
<Card title="Parámetros de afiliación" icon="arrow-right" href="/pagos-virtuales/sdk-mobile/android/afiliaciones/parametros-de-sdk-android">
