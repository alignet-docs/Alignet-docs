...
description: "Inicializa Alignet One SDK iOS para registrar o actualizar afiliaciones desde tu app móvil."
sidebarTitle: "Implementación"
---

<div className="ao-guide-rail ao-sdk-rail sdk-ios not-prose"><a href="/pagos-virtuales/sdk-mobile/ios/introduccion">← iOS</a><span>IOS / IMPLEMENTA</span></div>
...
El flujo de afiliaciones permite registrar o actualizar información asociada a un beneficiario desde Alignet One SDK iOS.

<Info>
  Antes de inicializar este flujo, completa [Instalación SDK iOS](/pagos-virtuales/sdk-mobile/ios/instalacion), revisa [Parámetros de afiliación](/pagos-virtuales/sdk-mobile/ios/afiliaciones/parametros-de-sdk-ios) y genera un `Access Token` desde backend usando [Autenticación](https://docs.pay-me.com/api-de-pagos/autenticacion).
</Info>
...
<Steps>
  <Step title="Importa el SDK">
    Agrega `UIKit` y `Alignet One` en el `ViewController` desde donde iniciarás el flujo.
  </Step>
...
<Card title="Parámetros de afiliación" icon="arrow-right" href="/pagos-virtuales/sdk-mobile/ios/afiliaciones/parametros-de-sdk-ios">
