---
title: "Parámetros de Entrada y Salida de Alignet One SDK iOS"
sidebarTitle: "Parámetros y respuestas"
description: "Referencia técnica de iOS: parámetros y respuestas."
---
...
# Cobros: Parámetros de Entrada y Salida de Alignet One SDK iOS

A continuación, se detallan los parámetros de entrada y salida de Alignet One SDK para el flujo de autorización.
...
| **Parámetro**     | **Tipo**                                                             | **Long.** | **Descripción**                                                                                   | **Obligatorio** |
| :---------------- | :------------------------------------------------------------------- | :-------- | :------------------------------------------------------------------------------------------------ | :-------------- |
| transactionId     | String                                                               | 25        | Identificador único de la transacción generado por Alignet One                                         | SI              |
