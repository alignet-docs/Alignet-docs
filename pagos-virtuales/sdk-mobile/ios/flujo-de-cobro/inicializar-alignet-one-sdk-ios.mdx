---
title: "Inicializar Alignet One SDK iOS"
...
La función de cobro permite invocar Alignet One SDK desde tu app iOS para mostrar el formulario de pago y recibir el resultado de la operación.

<Info>
  Antes de inicializar el SDK, completa [Instalación SDK iOS](/pagos-virtuales/sdk-mobile/ios/instalacion) y genera un `Access Token` desde tu backend usando [Autenticación](https://docs.pay-me.com/api-de-pagos/autenticacion).
</Info>
...
<Card title="Parámetros de entrada y salida" icon="arrow-right" href="/pagos-virtuales/sdk-mobile/ios/flujo-de-cobro/parametros-de-alignet-one-sdk-ios">
