...
description: "Recorre el flujo de cobro en Alignet One Flex: payload, inicialización y callbacks."
---
...
<CardGroup cols={3}>
  <Card title="1. Construcción del payload" icon="receipt" href="/pagos-virtuales/checkout-web/flex/construccion-del-payload">
    Arma la información de la operación, comprador, facturación y envío usando el mismo contrato base de PayIn.
  </Card>

  <Card title="2. Inicializar el componente" icon="gear" href="/pagos-virtuales/checkout-web/flex/inicializar-el-componente">
    Crea la instancia de `FlexPaymentForms`, envía `nonce`, `payload` y define cómo mostrar el formulario.
  </Card>

  <Card title="3. Capturar callbacks" icon="bolt" href="/pagos-virtuales/checkout-web/flex/capturar-funciones-callback">
...
<Steps>
  ...
  <Step title="Confirma desde backend">
    Para cerrar la orden o marcar el pago como final, complementa con [API de Consulta](https://docs.pay-me.com/payin/consulta) y, si aplica, con [Notificaciones](https://docs.pay-me.com/payin/notificaciones).
  </Step>
</Steps>
...
<Note>
  El objeto `response` recibido en `responseCallback` reutiliza el contrato del [API de Autorización - ecommerce](https://docs.pay-me.com/payin/autorizacion). La referencia exacta depende del método que el cliente eligió dentro de Flex.
</Note>
...
<CardGroup cols={2}>
  <Card title="Construcción del payload" icon="arrow-right" href="/pagos-virtuales/checkout-web/flex/construccion-del-payload">
    Revisa la estructura completa del request que Flex necesita para iniciar una operación.
  </Card>

  <Card title="Inicializar el componente" icon="arrow-right" href="/pagos-virtuales/checkout-web/flex/inicializar-el-componente">
  ...
  <Card title="API de Consulta" icon="arrow-right" href="https://docs.pay-me.com/payin/consulta">
