---
title: "API Nonce"
description: "Genera el Nonce necesario para inicializar Alignet One Flex después de autenticarte."
---
...
<Note>
  Antes de llamar a este endpoint, genera un `Access Token` con [Autenticación](https://docs.pay-me.com/api-de-pagos/autenticacion). El token debe enviarse en el header `Authorization`.
</Note>
...
<Card title="Incluir librería y estilos básicos" icon="arrow-right" href="/pagos-virtuales/checkout-web/flex/libreria-y-estilos-basicos">
