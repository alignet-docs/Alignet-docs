...
<CardGroup cols={2}>
  <Card title="Introducción Flex" icon="credit-card-front" href="/pagos-virtuales/checkout-web/flex/introduccion">
    Revisa el flujo principal de Checkout Web con Flex.
  </Card>

  <Card title="API Nonce" icon="shield-check" href="/pagos-virtuales/checkout-web/flex/api-nonce">
