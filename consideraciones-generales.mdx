...
<CardGroup cols={3}>
  <Card title="Ecommerce" icon="cart-shopping" horizontal href="https://alignet-dev.mintlify.site/ecommerce">
    Ver trama autorización Ecommerce.
  </Card>

  <Card title="POS" icon="credit-card" horizontal href="https://alignet-dev.mintlify.site/pos">
    Ver trama de autorización     POS.
  </Card>

  <Card title="Response" icon="reply" horizontal href="https://alignet-dev.mintlify.site/response">
