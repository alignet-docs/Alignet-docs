...
<CardGroup>
  <Card title="Ecommerce" icon="cart-shopping" href="/guia-integracion/ecommerce">
    Ver trama autorización Ecommerce.
  </Card>

  <Card title="POS" icon="credit-card" href="/guia-integracion/pos">
    Ver trama de autorización     POS.
  </Card>

  <Card title="Response" icon="reply" href="/guia-integracion/response">
