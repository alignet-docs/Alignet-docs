...
<Frame>
  <img className="theme-aware-image theme-aware-image-light" src="/images/virtual-payments-integration-types-light.png" alt="Alignet One integration types" />
  <img className="theme-aware-image theme-aware-image-dark" src="/images/virtual-payments-integration-types-dark.png" alt="Alignet One integration types in dark mode" />
</Frame>
