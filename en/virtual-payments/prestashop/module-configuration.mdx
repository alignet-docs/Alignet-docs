...
Configure the gateway's identity in your checkout:
...
These credentials connect your store to Alignet One. Request them from your account executive.
...
Customize how the gateway looks and operates.

### Implementing environment

<Tabs>
  <Tab title="Sandbox (Tests)">
    Use this mode to conduct fictitious transaction with test cards. It's ideal to validate that your server gets notifications correctly.
  </Tab>

  <Tab title="Production">
    Activate this mode only after you have completed the tests and have the actual credentials to process client money.
  </Tab>
</Tabs>
...
* **Embedded:** The payment form is integrated directly into the PrestaShop checkout page.
