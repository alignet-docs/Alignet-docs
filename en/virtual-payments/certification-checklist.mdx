...
<div className="ao-cover not-prose">
  <p className="ao-eyebrow"><span /> SANDBOX AND TESTING / FINAL REVIEW</p>
  <h2>Before going live.<br /><em>Everything verified.</em></h2>
  <p className="ao-lead">Gather your integration evidence and coordinate validation with Alignet before enabling live payments.</p>
</div>
...
<CardGroup cols={2}>
  <Card title="E-commerce" icon="store" href="/en/virtual-payments/e-commerce/integration-checklist">Checklist for WooCommerce, PrestaShop and VTEX.</Card>
  <Card title="Web Checkout" icon="globe" href="/en/virtual-payments/checkout-web/testing-and-production">Checklist for Flex.</Card>
  <Card title="Mobile SDK" icon="mobile-screen" href="/en/virtual-payments/sdk-mobile/integration-checklist">Checklist for Android and iOS.</Card>
</CardGroup>
