...
description: "Validations required to approve the integration and go live with Pay-me."
...
<CardGroup cols={2}>
  ...
  <Card title="Payments API" icon="server" href="https://docs.pay-me.com/api-de-pagos/checklist-de-integracion">Checklist for server-to-server integrations.</Card>
</CardGroup>
