...
description: "Core principles for preparing a secure Alignet One integration."
icon: "shield-check"
---
...
<CardGroup cols={2}>
  <Card title="E-commerce" icon="store" href="/en/virtual-payments/e-commerce/best-practices">Recommendations for plugins, commerce platforms, order management, and daily operations.</Card>
  <Card title="Web Checkout" icon="globe" href="/en/virtual-payments/checkout-web/testing-and-production">Guidance for integrating Alignet One Flex and handling `nonce`, callbacks, styles, and the web payment experience.</Card>
  <Card title="Mobile SDK" icon="mobile-screen" href="/en/virtual-payments/sdk-mobile/best-practices">Best practices for Android and iOS apps, packaging, callbacks, sessions, and device testing.</Card>
</CardGroup>
