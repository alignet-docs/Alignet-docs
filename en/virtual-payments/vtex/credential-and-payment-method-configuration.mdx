...
description: "Configure your Alignet One credentials and enable payment methods in VTEX."
---
After selecting **Alignet One** as the provider, configure authorization and integration parameters.

<Note>
  Alignet One provides the **App Key**, **App Token** and **Merchant Code** credentials. Each has a specific purpose.
</Note>
...
* **Accept payments with Cuotéalo:** select **Yes**.
