...
<Info>
  To conduct tests with `QR` and `PagoEfectivo` using simulators, contact [integration team](mailto:postventa.autenticacion@alignet.com). The equipment will give you the flow and available scenarios for your merchant.
</Info>

<CardGroup cols={3}>
  <Card title="Yape" icon="mobile-screen">
    Validate quick approval and rejection scenarios with phone number and code.
  </Card>
...
* **Logs:** Check the developer console to see the detailed response code.
