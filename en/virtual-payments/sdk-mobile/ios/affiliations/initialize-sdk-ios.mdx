...
<Info>
  Before we start this flow, complete [Installation SDK iOS](/en/virtual-payments/sdk-mobile/ios/installation)Check. [Affiliation parameters](/en/virtual-payments/sdk-mobile/ios/affiliations/sdk-ios-parameters) and generates an `Access Token` from backend using [Authentication](/en/api-reference/authentication/generate-access-token).
</Info>
