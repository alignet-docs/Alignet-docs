...
<div className="ao-guide-rail ao-sdk-rail sdk-ios not-prose"><a href="/en/virtual-payments/sdk-mobile/ios/introduction">← iOS</a><span>IOS / INSTALL</span></div>
...
<AccordionGroup>
  ...
  <Accordion title="Configure" icon="gear">
    ...
    * The app can import `Alignet One` successfully.
  </Accordion>
