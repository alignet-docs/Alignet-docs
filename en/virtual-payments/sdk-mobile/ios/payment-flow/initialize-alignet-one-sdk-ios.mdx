...
<div className="ao-guide-rail ao-sdk-rail sdk-ios not-prose"><a href="/en/virtual-payments/sdk-mobile/ios/introduction">← iOS</a><span>IOS / IMPLEMENT</span></div>
...
<Info>
  Before starting SDKcomplete [Installation SDK iOS](/en/virtual-payments/sdk-mobile/ios/installation) and generates an `Access Token` from your backend using [Authentication](/en/api-reference/authentication/generate-access-token).
</Info>
