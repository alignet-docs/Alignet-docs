...
sidebarTitle: "1. Requirements"
---

<div className="ao-guide-rail ao-sdk-rail sdk-android not-prose"><a href="/en/virtual-payments/sdk-mobile/android/introduction">← Android</a><span>ANDROID / PREPARE</span></div>
...
Before integrating, confirm that your merchant account and Android project meet the minimum requirements for Alignet One SDK.
...
The integration team will deliver the libraries to be incorporated into the project Android.
...
<Note>
  The sandbox environment is available for controlled testing. For testing with simulators or specific methods, coordinate with the integration team.
</Note>
