...
<Tip>
  For methods such as **PagoEfectivo** or flows that require delayed confirmation, you can support with support team if you have to validate manual stage approval.
</Tip>
