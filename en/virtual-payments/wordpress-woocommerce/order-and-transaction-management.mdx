...
<Warning>
  **Important:** If your server's under maintenance or under a firewall that blocks the IP from Alignet Onethe status of the order shall not be updated automatically. Always check the **Logs** If this happens.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Tests and certification" icon="vial-circle-check" href="/en/virtual-payments/wordpress-woocommerce/testing-and-certification">
    Validate that states change correctly with our test cards.
  </Card>
