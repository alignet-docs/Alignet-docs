...
In WordPress admin, go to **WooCommerce** > **Settings** > **Payments** > **Alignet One Checkout** > **Finish setup**.
...
The plugin requires two keys to encrypt communication. Generate or retrieve them from the **Alignet One administration portal**.
...
To receive successful payment notifications from Alignet One, especially for asynchronous methods, configure the response URL in your Alignet One account:
