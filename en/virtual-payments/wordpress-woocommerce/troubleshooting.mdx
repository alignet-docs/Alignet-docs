...
1. Go to **WooCommerce** > **State** > **Logs**.
...
<Tip>
  Can compare the error codes found in the login with our [Response Codes Guide](/en/virtual-payments/payments/return-codes).
</Tip>
...
If the problem persists after revising the above points, prepare the following information for our support team:
