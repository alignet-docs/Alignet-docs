---
title: "Redirect"
description: "Integrate VPOS through a redirect and receive the result on the merchant website."
icon: "arrow-up-right-from-square"
---

**Alignet Redirect** sends the buyer from the merchant website to the VPOS gateway. The merchant prepares a signed HTML form, submits it by HTTPS POST, and receives the transaction result at its response URL.
...
<Steps>
  ...
  <Step title="Receive the notification">
    VPOS returns the parameters to the merchant website through the buyer's browser.
  </Step>
