...
description: "Essential fields for requesting a payment and validating the VPOS response."
icon: "arrows-rotate"
---
...
* `authorizationResult`: `00` authorized, `01` denied by the issuer, or `05` rejected by VPOS.
