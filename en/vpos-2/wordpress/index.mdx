...
description: "Condensed guide for integrating VPOS into a WooCommerce store."
icon: "wordpress"
---

Integrate VPOS into a WordPress and WooCommerce store using the Alignet payment plugin.
